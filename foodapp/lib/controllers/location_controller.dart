...
import 'package:foodapp/data/api/api_checker.dart';
...
class LocationController extends GetxController implements GetxService{
  ...
  Future<String> getAddressfromGeocode(LatLng latlng) async {
    ...
    if(response.body["status"]=='OK'){
      ...
      print("Falling back to Temporary Address");
      _address=("1983 SW Carter Ln, Portland, OR 97201, USA");
    }
    update();
    return _address;
  }
...
/*    Response response = await locationRepo.getZone(lat, lng);
    ...
    print("ZONE RESPONSE STATUS TEXT"+response.statusCode.toString());*/
