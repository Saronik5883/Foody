...
//Actual getZone method for use with the api
  ...
  //change it to place_id if it doesnt work
  Future<Response> setLocation(String placeID) async{
    return await apiClient.getData('${AppConstants.PLACES_DETAILS_URI}?placeid=$placeID');
  }
}